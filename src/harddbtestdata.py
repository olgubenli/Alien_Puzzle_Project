...
AMAÇ: 'k=7' (Tüm 56 eşleşme) verisindeki TÜM BENZERSİZ asteroidleri
      almak ve aralarındaki TÜM OLASI (N x N) "serbest uçuş"
      maliyetlerini hesaplayıp bir sqlite veritabanına yazmak.
...
DB_FILE_NAME = "uzayli_bulmacasi_matrix.db"
...
def generate_asteroid_metro_map(final_routes, asteroid_graph, asteroid_to_match):
    ...
    pass # Bu kodda metro haritası çizmiyoruz
...
def main():
    ...
    try:
        ...
        # itertools.product(asteroid_ids, repeat=2) tüm A->A, A->B, A->C...
        # B->A, B->B... permütasyonlarını oluşturur.
